...
/* ── Navigation icons (Tabler Icons — usable beyond sidebar) ── */

export const IconHome = ({ size = 20, strokeWidth = defaults.strokeWidth }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
    stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
...
export const IconUser = ({ size = 20, strokeWidth = defaults.strokeWidth }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
    stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
...
export const IconStar = ({ size = 20, strokeWidth = defaults.strokeWidth }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
    stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
...
export const IconTag = ({ size = 20, strokeWidth = defaults.strokeWidth }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
    stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
...
export const IconChartBar = ({ size = 20, strokeWidth = defaults.strokeWidth }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
    stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
...
export const IconSettings = ({ size = 20, strokeWidth = defaults.strokeWidth }: IconProps) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
    stroke="currentColor" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round">
